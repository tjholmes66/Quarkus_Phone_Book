...
@QuarkusTest
public class ContactPhoneRepositoryTest {
    @Inject
    ...
    public void testCreate() throws Exception
    {
        ...
        contactPhoneRepository.persist(contactPhone);
    ...
    public void testContactRetrieveById()
    {
        ...
        ContactPhoneEntity contactPhone = contactPhoneRepository.findById(null);
        ;
        assertNotNull(contactPhone.getPhoneId());
        // ************************************************************
        assertNotNull(contactPhone.getPhoneId());
    ...
    public void XtestContactDelete()
    {
        ...
        // ***************************************************************
        long id = 10;
        contactPhone = contactPhoneRepository.findById(null);
        contactPhoneRepository.delete(contactPhone);
        contactPhoneGet = contactPhoneRepository.findById(null);
