...
public class LinkTypeRepositoryTest {
    ...
    public void testLinkTypeSave()
    {
        ...
        linkTypeRepository.persist(linkType);
    ...
    public void testLinkTypeRetrieve()
    {
        ...
        List<LinkTypeEntity> linkTypes = linkTypeRepository.findAll().list();
    ...
    public void testLinkTypeDelete()
    {
        ...
        // =================================================================================
        long linkTypeId = 1;
        LinkTypeEntity linkType = linkTypeRepository.findById(linkTypeId);
        linkTypeRepository.delete(linkType);

        LinkTypeEntity linkTypeGet = linkTypeRepository.findById(linkTypeId);
