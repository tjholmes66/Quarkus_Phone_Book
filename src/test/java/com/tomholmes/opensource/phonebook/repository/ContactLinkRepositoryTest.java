...
@QuarkusTest
public class ContactLinkRepositoryTest {
    ...
    public void testContactRetrieve()
    {
        ...
        List<ContactLinkEntity> contactLinks = contactLinkRepository.findAll().list();
    ...
    public void testContactRetrieveById()
    {
        ...
        ContactLinkEntity contactLink = contactLinkRepository.findById(id);
        assertNotNull(contactLink.getLinkId());
        // ************************************************************
        assertNotNull(contactLink.getLinkId());
        assertNotNull(contactLink.getContact());
    ...
    public void XtestContactDelete()
    {
        ...
        // ***************************************************************
        long id = 10;
        contactLink = contactLinkRepository.findById(id);
        contactLinkRepository.delete(contactLink);
        contactLinkGet = contactLinkRepository.findById(id);
    ...
    */
    ...
    public void testContactUpdate()
    {
        ...
        // =================================================================================
        ContactLinkEntity contactLink = contactLinkRepository.findById(null);
