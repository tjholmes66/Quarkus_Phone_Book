...
public class ContactEmailRepositoryTest
{
    ...
    public void testCreate() throws Exception
    {
        ...
        contactEmailRepository.persist(contactEmail);
    ...
    public void testContactRetrieve()
    {
        ...
        List<ContactEmailEntity> contactEmails = (List<ContactEmailEntity>) contactEmailRepository.findAll().list();
    ...
    public void testContactRetrieveById()
    {
        ...
        ContactEmailEntity contactEmail = contactEmailRepository.findById(id);
        assertNotNull(contactEmail.getEmailId());
        // ************************************************************
        assertNotNull(contactEmail.getEmailId());
        assertNotNull(contactEmail.getContact());
    ...
    public void XtestContactDelete()
    {
        ...
        // ***************************************************************
        long id = 10;
        contactEmail = contactEmailRepository.findById(id);
        contactEmailRepository.delete(contactEmail);
        contactEmailGet = contactEmailRepository.findById(id);
    ...
    */
    ...
    public void testContactUpdate()
    {
        ...
        // =================================================================================
        ContactEmailEntity contactEmail = contactEmailRepository.findById(null);
